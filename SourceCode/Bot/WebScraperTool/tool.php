...
if(isset($_POST['txt_url']) && isset($_POST['txt_job'])&& isset($_POST['txt_company'])
&& isset($_POST['txt_location']) && isset($_POST['txt_description'])&& isset($_POST['txt_salary'])
&& isset($_POST['txt_requirement']) && isset($_POST['txt_benifit'])&& isset($_POST['txt_expired'])
)
{
	$data = curl_download($_POST['txt_url']);
// 	$html = new simple_html_dom();
