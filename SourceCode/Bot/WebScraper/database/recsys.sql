...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2015 at 05:33 AM
...
('https://itviec.com/?page=', 'https://itviec.com', '/div[class="first-group"]/div[class="job"]/div/div[2]/div[1]/a', '//*[@id]/div[2]/div/div[3]/div[1]/div/h1', '//*[@id]/div[2]/div/div[2]/div[1]/h3', '//*[@id="job-details-mobile"]/div[3]/div/div[1]', '//*[@id]/div[6]/div/div', '//*[@id]/div[3]/div/div[2]/span[2]', '//*[@id]/div[7]/div/div', '//*[@id]/div[8]/div/div[1]', '//*[@id]/div[2]/div/div[3]/div[1]/div/div[5]', '//*[@id]/div[3]/div/div[3]/div', '', '', 1),
('https://www.careerlink.vn/vieclam/tim-kiem-viec-lam?sid=34134145&token=LjKUHJM0&page=', 'https://www.careerlink.vn', '//*[@id="save-job-form"]/div/div/h2/a', '/html/body/div[2]/div[1]/h1', '/html/body/div[2]/div[2]/div[1]/div/ul[1]/li[1]/a', '/html/body/div[2]/div[2]/div[1]/div/ul[1]/li[2]', '/html/body/div[2]/div[2]/div[1]/div/ul[2]', '/html/body/div[2]/div[2]/div[1]/div/ul[1]/li[3]', '/html/body/div[2]/div[2]/div[1]/div/div[3]', '', '/html/body/div[2]/div[2]/div[1]/div/dl/dd[2]', '/html/body/div[2]/div[2]/div[1]/div/p', '', '', 2);
...
ALTER TABLE `job_xpath`
  ADD PRIMARY KEY (`home_url`), ADD UNIQUE KEY `id` (`id`);
